# Comfy Workflow H3 T2va Realism

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-t2va-realism. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-t2va-realism
```
...
- model: `h3-realism-people-t2v-i2v-r2v.safetensors`

## Inspect & run

```sh
cwf inspect @stepupgaming/comfy-workflow-h3-t2va-realism --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-t2va-realism --url http://127.0.0.1:8188
```
