# Comfy Workflow H3 Continue Vae Tail

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-continue-vae-tail. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-continue-vae-tail
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-continue-vae-tail --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-continue-vae-tail --url http://127.0.0.1:8188
```
