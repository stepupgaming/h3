# Comfy Workflow H3 T2va Fbc

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-t2va-fbc. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-t2va-fbc
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-t2va-fbc --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-t2va-fbc --url http://127.0.0.1:8188
```
