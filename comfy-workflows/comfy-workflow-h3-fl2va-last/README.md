# Comfy Workflow H3 Fl2va Last

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-fl2va-last. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-fl2va-last
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-fl2va-last --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-fl2va-last --url http://127.0.0.1:8188
```
