...
Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-ganloss-stage1. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-ganloss-stage1
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-ganloss-stage1 --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-ganloss-stage1 --url http://127.0.0.1:8188
```
