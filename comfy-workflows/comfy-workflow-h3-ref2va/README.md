...
MiniMax-H3 reference-to-video. Gemmy `video h3 generate --mode ref2va`.

Unofficial project. Not affiliated with or endorsed by Comfy Org.

## Purpose

Generate video+audio from a reference image with MiniMax-H3 Ref2VA.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-ref2va
```
...
- `unet` (default "minimax_h3_ref2va_pruned_int8_convrot.safetensors")
...
- `latent_prefix` (default "h3/ref2va_av")
- `output_prefix` (default "h3/ref2va")
- `fingerprint` (default "{}")
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-ref2va --url http://127.0.0.1:8188
cwf run @stepupgaming/comfy-workflow-h3-ref2va --url http://127.0.0.1:8188 --param prompt=...
```
