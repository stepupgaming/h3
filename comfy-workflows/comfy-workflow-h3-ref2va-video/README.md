# Comfy Workflow H3 Ref2va Video

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-ref2va-video. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-ref2va-video
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-ref2va-video --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-ref2va-video --url http://127.0.0.1:8188
```
