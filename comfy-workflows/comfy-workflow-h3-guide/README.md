# Comfy Workflow H3 Guide

Imported ComfyUI workflow packaged as @stepupgaming/comfy-workflow-h3-guide. Verify license and redistribution rights before publishing.
...
```sh
pnpm add @stepupgaming/comfy-workflow-h3-guide
```
...
```sh
cwf inspect @stepupgaming/comfy-workflow-h3-guide --url http://127.0.0.1:8188

cwf run @stepupgaming/comfy-workflow-h3-guide --url http://127.0.0.1:8188
```
